...
public class MathUtils {
	...
	public static double divide(String dividend,String divisor){
		try {
			...
			BigDecimal dividendBD = new BigDecimal((StringUtils.isNotBlank(dividend))?dividend.trim():"0");
			BigDecimal divisorBD = new BigDecimal((StringUtils.isNotBlank(divisor))?divisor.trim():"1");
